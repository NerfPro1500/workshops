...
Game: <span class="blank-line-short"></span>
...
Open the Mechanics Demo game and play for a few minutes. Then answer:
...
Pick a mechanic you want to design. It can be anything — wall jump, grapple,
time freeze, invisibility, shapeshifting, etc.

My mechanic: <span class="blank-line-short"></span>

**Step 1 — How does the player find it?**
(Item pickup? Talking to someone? Accident?)

<span class="blank-line-long"></span>

**Step 2 — Where do they practice it safely?**
(A room with no enemies? A low-stakes puzzle?)

<span class="blank-line-long"></span>

**Step 3 — What does it unlock or open up?**
(A new area? A shortcut? A new enemy type they can now defeat?)
